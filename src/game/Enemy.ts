...
const CONFIGS: Record<EnemyType, EnemyConfig> = {
  ...
  speeder:  { speed: 95,  maxHp: 15, textureKey: 'enemy_speeder',   contactDamage: 8,  xpValue: 3,  scale: 1.2, frameRate: 12 },
  tank:     { speed: 65,  maxHp: 40, textureKey: 'enemy_tank',      contactDamage: 20, xpValue: 8,  scale: 1.8, frameRate: 5  },
