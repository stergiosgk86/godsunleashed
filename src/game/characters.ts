...
export const CHARACTER_DEFS: Record<CharacterType, CharacterDef> = {
  ...
  zeus: {
    ...
    description: 'King of Olympus. Devastating might and divine regen. Slower but unstoppable.',
    ...
    attackIntervalMult: 1.0, dashCooldownMult: 1.0, bonusDashDistance: 0,
    bonusHpRegen: 0.3, startAura: 0, lifeDrain: 0, startLightning: false, startBoomerang: false, frontArcOnly: false,
    scale: 1.0,
    menuFrame: { fw: 96, fh: 96, sw: 288, sh: 768 },
  },
  poseidon: {
    id: 'poseidon', name: 'Poseidon', trait: 'Trident of the Deep',
    description: 'God of the Sea. Swift trident attacks, divine armor, and a powerful HP pool.',
