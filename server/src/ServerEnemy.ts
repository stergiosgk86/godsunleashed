...
const CONFIGS: Record<EnemyKind, Cfg> = {
  basic:       { speed: 80,   maxHp: 25,   xpValue: 2,   isBoss: false },
  speeder:     { speed: 190,  maxHp: 10,   xpValue: 1,   isBoss: false },
  tank:        { speed: 35,   maxHp: 100,  xpValue: 6,   isBoss: false },
  ranged:      { speed: 55,   maxHp: 30,   xpValue: 4,   isBoss: false },
  exploder:    { speed: 65,   maxHp: 40,   xpValue: 4,   isBoss: false },
  ghost:       { speed: 280,  maxHp: 8,    xpValue: 2,   isBoss: false },
  charger:     { speed: 55,   maxHp: 45,   xpValue: 5,   isBoss: false },
  necromancer: { speed: 40,   maxHp: 40,   xpValue: 5,   isBoss: false },
